                        ...
                        if(isset($_GET['search'])) {
                           ...
                           if(sizeof($data_product_search)>0) {
                              for($i=0; $i<sizeof($data_product_search); $i++) {
                                 ...
                                 <div class="col-md-4 p-2">
                                    <div class="card p-0">
                                       <div style="width: 100%; height: 400px; overflow: hidden; background: url('<?php echo $data_product_search[$i]['image']; ?>') no-repeat center center; background-size: cover;"></div>
                                       <div class="card-body">
                           ...
                           if(sizeof($data_product)>0) {
                              for($i=0; $i<sizeof($data_product); $i++) {
                                 ...
                                 <div class="col-md-4 p-2">
                                    <div class="card p-0">
                                       <div style="width: 100%; height: 400px; overflow: hidden; background: url('<?php echo $data_product[$i]['image']; ?>') no-repeat center center; background-size: cover;"></div>
                                       <div class="card-body">
