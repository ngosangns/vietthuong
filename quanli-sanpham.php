            ...
            for($i=0; $i<sizeof($data_product); $i++) {
                ?>
                    <tr>
                        ...
                        <td class="text-right"><a class="btn btn-success text-white mt-1 mb-1" href="./edit-sanpham.php?id=<?php echo $data_product[$i]['id']; ?>"><i class="fa fa-edit"></i></a> <button class="btn btn-danger mt-1 mb-1" type="button" onclick="confirmDelete(this)" href="./delete.php?productid=<?php echo $data_product[$i]['id']; ?>"><i class="fa fa-trash"></i></button></td>
                    <tr>
            </div>
                <!--end_product-->
                <?php
